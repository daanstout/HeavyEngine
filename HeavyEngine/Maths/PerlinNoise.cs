namespace HeavyEngine {
    public static class PerlinNoise {
        public static float Perlin(float x, float y) => Perlin(x, y, 0.0f);
        ...
        public static float Perlin(float x, float y, int octaves, float persistence, float lacunarity) => Perlin(x, y, 0.0f, octaves, persistence, lacunarity);

        public static float Perlin(float x, float y, float z, int octaves, float persistence, float lacunarity) {
            var total = 0.0f;
            var frequency = 1.0f;
            var amplitude = 1.0f;
